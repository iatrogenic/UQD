...
\begin{remark}
	The random variable $Y$ above is not necessarily unique. What we do have is that any other random variable $Z$ with the same properties agrees with $Y$ almost surely, i.e. $\PP(Y = Z) = 1$. 
\end{remark}
